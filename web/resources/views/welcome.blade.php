            ...
            <nav class="navbar navbar-expand-lg" style="background: #4B2067;">
                <div class="container d-flex align-items-center">
                    ...
                    <div class="nav-item dropdown me-3">
                        <a class="nav-link dropdown-toggle text-white" href="#" id="danhMucDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="transition: background 0.2s, color 0.2s;">
                            Danh mục
                        </a>
                        <div class="dropdown-menu p-4" aria-labelledby="danhMucDropdown" style="width: 900px; max-width: 100vw; ">
                            ...
                            <div class="row flex-nowrap" style="min-width: 320px; width: 100%; max-width: 100%; overflow-x: auto;">
                                <div class="col-3">
                                    ...
                                    <a class="dropdown-item" href="#">Tâm lý - Kĩ năng sống</a>
                                    <a class="dropdown-item" href="#">Nuôi dạy con</a>
                                    <a class="dropdown-item" href="#">Sách thiếu nhi</a>
                                    <a class="dropdown-item" href="#">Tiểu sử - Hồi ký</a>
                                    <a class="dropdown-item" href="#">Sách mới <span style='color:red'>&hearts;</span></a>
                                    <a class="dropdown-item" href="#">Xem tất cả</a>
                                </div>
                                <div class="col-3">
                                    <h6 class="fw-bold">VPP - Dụng Cụ Học Sinh</h6>
                                    <a class="dropdown-item" href="#">Bút</a>
                                    <a class="dropdown-item" href="#">Sổ tay</a>
                                    <a class="dropdown-item" href="#">Thước kẻ</a>
                                    <a class="dropdown-item" href="#">Gôm/Tẩy</a>
                                    <a class="dropdown-item" href="#">Bìa hồ sơ</a>
                                    <a class="dropdown-item" href="#">Dụng cụ khác</a>
                                    <a class="dropdown-item" href="#">Xem tất cả</a>
                                </div>
                                <div class="col-3">
                                    ...
                                    <a class="dropdown-item" href="#">Lớp 4</a>
                                    <a class="dropdown-item" href="#">Lớp 5</a>
                                ...
                                <div class="col-3">
                                    ...
                                    <a class="dropdown-item" href="#">Tiếng Hoa</a>
                                    <a class="dropdown-item" href="#">Tiếng Hàn</a>
                                    <a class="dropdown-item" href="#">Xem tất cả</a>
                                </div>
                            </div>
                        </div>
